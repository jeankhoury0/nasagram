        ...
        <div className="shadow-lg bg-white rounded-xl mx-2 break-inside-avoid overflow-hidden">
            ...
            <div className="grid grid-cols-3 overflow-hidden">
                ...
                <div className="flex justify-between grow items-stretch ">
                    ...
                    <button className="fas fa-link grow text-2xl ease-in duration-300 hover:bg-blue-700 hover:text-white hover:scale-110 " aria-label="Get link to share"></button>
